...
- 🧩 **Comprehensive Question Bank:** Includes 100 carefully selected React interview questions  
- 📊 **Multiple Choice Format:** Each question comes with four options and one correct answer  
- 💾 **Local JSON Data Fetching:** Uses `fetch()` to load questions dynamically from a JSON file  
...
### 👩‍💻 About the Project  
This project was created to help developers **prepare for React interviews** by practicing with real-world questions. The goal was to design a simple yet effective quiz interface that demonstrates:  
